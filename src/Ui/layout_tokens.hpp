...
// ── Toolbar principal ────────────────────────────────────────────────────────
namespace Toolbar {
inline constexpr int kHeight{46}; // deve coincidir com min/max-height no QSS
...
inline constexpr QSize kModeDropdownSize{
    96, 30}; // largura fixa do dropdown de modos
